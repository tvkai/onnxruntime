  ...
  if (fbs_data_type == fbs::TensorDataType::STRING) {
    ...
    switch( fbs_data_type ) {
       ...
       case fbs::TensorDataType::INT32:
            element_size=4;
            break;
       case fbs::TensorDataType::UNDEFINED:
            element_size=1;
            break;
       ...
       case fbs::TensorDataType::UINT64:
            element_size=8;
            break;
       case fbs::TensorDataType::COMPLEX64:
            element_size=8; 
            break;
       case fbs::TensorDataType::COMPLEX128:    
            element_size=16;
            break;
    ...
    char *bytes = (char *)fbs_tensor.raw_data();
    int num_elements = fbs_raw_data->size()/element_size;
    ...
    for (i = 0; i < num_elements; ++i) {
         ...
         /* keep swapping */
         for (int count = 0; count < element_size / 2; ++count) {
